...
void vaccine ::view_vaccine()
{
    ...
    int s=num_of_vaccine-i;
       cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 VACCINE HANDLING SYSTEM  \xB3\xB2=\xB2=\xB2-\xB3\n\n"<<endl;
    cout<<"\t\t\t\t\t\t Powered By:- CMRCET BATCH-17 "<<endl<<endl;
    cout<<"\n\t\t\t***************\n";
    ...
    cin>>ch;
    int f_var=0;
    fstream file("count1.txt",ios::out | ios::in);
    file>>f_var;
    switch(ch)
    {
    case 1:
...
void vaccine::search_data()
{
    ...
    cout<<"\n\t\t 3. By profession \t\t 4. By gender \t\t 5.By Vaccine_Type"<<endl;
    cout<<"\n\n\t\tEnter your choice ...............";
    int ch;
    cin>>ch;
    switch(ch)
...
void vaccine::search_by_aadhar()
{
    ...
    fflush(stdin);
    int l1=5;
    while(getline(cin,adh_num) && l1!=0){
            if(adh_num.size()==12){
                    break;
            }
            else{
                    l1--;
                cout<<"\n\t please enter a valid aadhar number :-"<<endl;
            }
    }
...
void vaccine::search_by_vaccinetype()
{
    ifstream in("vaccinetrial1.txt");
    int flag =0;
    int v=0;
    ...
    cout<<"\t\t\t\t\t\t Powered By:- CMRCET BATCH-17"<<endl<<endl;
    cout<<"\n\t\t\t***************\n";
    cout<<"\t\t\t\t VACCINE_TYPE SEARCHING ";
    cout<<"\n\t\t\t***************\n\n";
    cout<<"enter vaccine type by which you want to search "<<endl;
    fflush(stdin);
    getline(cin,enter);
    show();
    in.read((char*)this,sizeof(vaccine));
    ...
    if(flag==0)
    {
    cout<<"The vaccineType you have Enter does not exist"<<endl;
    }
    cout<<"\n\n\n NO of people vaccinated by this VaccineType "<<v<<endl;
    in.close();
}
...
void vaccine::setdata()
{
    ...
    fflush(stdin);
        ...
        int m=10;
        while(getline(cin,mobile_number)){
            if(mobile_number.size()==m){
                    break;
            }
            else{
                cout<<"\n\t\t\t please enter a valid mobile number"<<endl;
            }
        }
...
void vaccine::showdata()
{
   ...
   cout<<"\t\t Aadhar number is: "<<aadhar<<endl;
    ...
    cout<<"\t\t VaccineType is : "<<stype<<endl;
...
{
    fstream outin;
    outin.open("vaccinetrial1.txt",ios::app|ios::in);
    setdata();
...
void vaccine::handle_vaccine(){
    cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 IF THERE IS ANY NEED OR HELP WE ARE HERE \xB3\xB2=\xB2=\xB2-\xB3\n\n"<<endl;
    cout<<"---> FIRSTLY THERE IS AN LOGIN PAGE DESIGNED FOR ADMINS WHO CAN HAVE AN SECURITY FOR THERE DATA"<<endl;
    cout<<"---> THE NEXT PAGE EXPLAINS ABOUT THE DIFFERENT ATTRIBUTES OR FEATURES OF THE PROJECT"<<endl;
    cout<<"---> AS THE ADMINS PREFERNCE THE INDIVIDUAL ATTRIBUTES WILL BE WORKING WHERE AS \n\t\t --> THERE ARE DIFFERENT ATTRIBUTES\n\t\t\t 1.ADD DATA\n\t\t\t\t WE CAN ADD DATA BY THE DIFFERENT FORM DETAILS THAT INCLUDES NAME, ADDHAR NO, GENDER, PHONE NO, BP etc\n\t\t\t 2. VIEW DATA :\n\t\t\t\t THIS CONSIST OF DETAILED INFORMATION ABOUT THE VACCINES DATA SUCH AS ADD VACCINES ,VIEW STATUS , VIEW AVAILABILTY etc..\n\t\t\t 3. SEARCH :\n\t\t\t\t IT GIVES THE DIFFERENT WAYS TO SEARCH THE DETAILS OF VACCINES BY USING FEILDS SUCH AS BY ADDAHR, BY AGE, BY GENDER, BY PROFFESION...\n\t\t\t 4 HELP DESK,5 EXIT : THIS TWO ARE GENERAL OPTIONS USED IN ANY HELP AND LEAVE THE EXECTION BY SELECTING EXIT()\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t  ******THANK YOU******\n\t\t \n\t\t "<<endl;
    getch();
}
...
void menu()
{
    ...
    cout<<"\n\t\t3: search   \t\t\t\t 4: Help desk \t\t\t\t 5: exit"<<endl;
}
int main()
 {
     vaccine obj;
     ...
     int num_vac;
    cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 VACCINE HANDLING SYSTEM  \xB3\xB2=\xB2=\xB2-\xB3\n\n"<<endl;
    cout<<"\t\t\t\t\t\t Powered By:- CMRCET BATCH-17 "<<endl;
...
int password()
{
    ...
    srand(time(0));
    cap=rand();
    cout<<"\n\t\t\t\t\t CAPTURE:->  "<<cap<<endl<<endl;
    cout<<" Please enter the valid capture :-   ";
    cin>>capt;
    if( (strcmp(cname,"CMRCET")==0) && (strcmp(pass,"1234")==0) && cap==capt)
        return 1;
    else
        return 0;
}
